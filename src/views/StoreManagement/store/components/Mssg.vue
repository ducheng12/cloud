  ...
  <div>
    ...
    <el-form class="Mssg_form">
      ...
      <el-form-item label-width="72" label="设备ID：" class="my_form-item fontWeig">
        ...
        <p class="imgPa">设备ID的格式为：xx:xx:xx:xx:xx:xx</p>
      </el-form-item>
    </el-form>
    <!-- <h4>商品详情</h4> -->
...
export default {
  ...
  methods: {
    ...
    addDevice() {
      const num = /^[A-Fa-f\d]{2}:[A-Fa-f\d]{2}:[A-Fa-f\d]{2}:[A-Fa-f\d]{2}:[A-Fa-f\d]{2}:[A-Fa-f\d]{2}$/
      ...
      if (!num.test(this.mirrorNos)) {
        this.$message.warning('请输入正确的设备ID')
        return false
      }
